    ...
    <div className="VerifyProperty">
      ...
      <div className="PropertyDetailsCard">
        ...
        <div className="land-title-price">
          <h1 className="land-title">Item Title</h1>
          <div className="land-price">RMXX.XX</div>
        </div>
        ...
        <div className="land-details">
          ...
          <div className="land-property-info">
              ...
              <div className="info-section">
                  ...
                  <div className="info-value" id="land-location">Damansara, Selangor</div>
                </div>
                <div className="info-section">
                  <div className="info-label">Property Type</div>
                  <div className="info-value" id="land-property-type">Land For Sale</div>
                </div>
                <div className="info-section">
                  <div className="info-label">Land Size</div>
                  <div className="info-value" id="land-size">2120 sqft</div>
                </div>
                <div className="info-section">
                  <div className="info-label">Land Type</div>
                  <div className="info-value" id="land-type">Development Land</div>
                </div>
                <div className="info-section">
                  <div className="info-label">Tenure</div>
                  <div className="info-value" id="land-tenure">Freehold </div>
                </div>
              </div>
          </div>
        </div>
